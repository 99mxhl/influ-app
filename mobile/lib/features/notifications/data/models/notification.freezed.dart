...
class _$AppNotificationImpl implements _AppNotification {
  ...
  @override
  String toString() {
    return 'AppNotification(id: $id, type: $type, title: $title, description: $description, actionUrl: $actionUrl, referenceId: $referenceId, read: $read, readAt: $readAt, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, type, title, description,
      actionUrl, referenceId, read, readAt, createdAt);
