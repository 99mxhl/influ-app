...
class _$MessageImpl implements _Message {
  ...
  @override
  String toString() {
    return 'Message(id: $id, conversationId: $conversationId, senderId: $senderId, senderDisplayName: $senderDisplayName, type: $type, content: $content, referenceId: $referenceId, createdAt: $createdAt, readAt: $readAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, conversationId, senderId,
      senderDisplayName, type, content, referenceId, createdAt, readAt);
...
abstract class _Message implements Message {
  const factory _Message(
      ...
      final String? referenceId,
      final DateTime? createdAt,
      final DateTime? readAt}) = _$MessageImpl;
...
abstract class $SendMessageRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String content, MessageType type, String? referenceId});
}
...
class _$SendMessageRequestImpl implements _SendMessageRequest {
  const _$SendMessageRequestImpl(
      {required this.content, this.type = MessageType.text, this.referenceId});
  ...
  @override
  String toString() {
    return 'SendMessageRequest(content: $content, type: $type, referenceId: $referenceId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, content, type, referenceId);
...
abstract class _SendMessageRequest implements SendMessageRequest {
  const factory _SendMessageRequest(
      {required final String content,
      final MessageType type,
      final String? referenceId}) = _$SendMessageRequestImpl;
